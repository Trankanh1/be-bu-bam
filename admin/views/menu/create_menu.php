    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form role="form" method="post" action="<?php echo BASE_URL ?>admin.php?p=menu&act=store&id=<?php echo @$_GET['id']?> ">
                    <div class="row">
                        <!-- left column -->
                        <div class="col-md-2">
                            <!-- /.box -->
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <input type="text" name="name[]" class="form-control"  placeholder="Nhập tên liên kết">
                      <input type="hidden" id="data-menu" n class="form-control" value="1">
                </div>
                <div class="col-md-3">
            ...
            $.getJSON( 'http://lap-trinh-web.com/admin.php?p=menu&act=searchCategory&key='+keySearch, function(data) {
              ...
              if(Object.keys(data).length > 1){
                  ...
                  $.each(data, function(key,val)  {
                   ...
                   $('#id_'+selectboxId + ' .menu-content-link').html('<div class="col-md-3"><select name="links[]" style="background-color:#f4f4f4" class="form-control list-cate" >'+item.join("")+'</select></div>').show();
               }) ;
