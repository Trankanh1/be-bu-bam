                ...
                <div class="box">
                    <div class="box-header">
                        <div>
                            ...
                            <div style="float:right;margin-bottom:10px "><a href="<?php echo BASE_URL?>admin.php?p=category&act=create&role=admin" class="btn btn-block btn-primary btn-sm">Tạo danh mục</a></div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                    ...
                                    <?php if (count($products) > 0) : ?>
                                        <?php  foreach ($products as $product ) :?>
                                            <tr>
                                             ...
                                             <td>
                                                <a href="<?php echo BASE_URL ?>admin.php?p=category&act=edit&id=<?php echo $product['id'] ?>" class="btn btn-default"><i class="fa fa-fw fa-edit"></i></a>
                                                <a href="<?php echo BASE_URL ?>admin.php?p=category&act=deleteCate&id=<?php echo $product['id'] ?>" class="btn btn-danger"><i class="fa fa-fw fa-trash-o fa-lg "></i> </a>
