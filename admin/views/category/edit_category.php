                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo   $category[0]['name']?>"  name = "name" placeholder="Nhập tên danh mục">
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả</label>
                                        <textarea  value="<?php echo $category[0]['name']?>"  id="editor1" name="description" rows="10" cols="80">                                   
                                    </textarea>
                                    </div>
