    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form role="form" method="post" action="<?php echo BASE_URL ?>?p=category&act=store&role=admin">
                    <div class="row">
                        <!-- left column -->
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <div class="col-sm-10">
                                            <input type="radio" name="status" id="" value="1"> Hiển thị
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-10">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="box-footer">
                                        <input type="file" name="" id="" class="btn btn-info pull-right">
                                    </div>
                                    <!-- /.box-footer -->
                                </div>
                            </div>
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Gắn lên menu</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
