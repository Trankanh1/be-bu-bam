    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form role="form" method="post" action="<?php echo BASE_URL?>admin.php?p=blog&act=update&id=<?php echo $blog[0]['id'];?> " enctype="multipart/form-data">
                    <div class="row">
                        <!-- left column -->
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label> Tiêu đề</label>
                                        <input type="text" class="form-control" name ="title" placeholder="Nhập tên danh mục"  value="<?php echo $blog[0]['name'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Nội dung bài viết</label>
                                        <textarea id="editor1" name="description" rows="10" cols="100"> <?php echo $blog [0]['content'];?>                                  
                                    </textarea>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <div class="horizontal-image"> 
                                            <img style="width: 274px; height: 240px" src="<?php echo $blog [0]['cover_image'] ?>">
                                        </div> 
                                    </div >
                                    <!-- /.box-body -->
                    ...
                    <div class="box-footer">
                        <a href="<?php echo BASE_URL ?>admin.php?p=blog&act=index" style="margin-right:5px" class="btn btn-danger btn-lg">Hủy</a>
