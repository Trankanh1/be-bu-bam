...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="../../index2.html"><b>3B</b>web</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      <p class="login-box-msg">Nhập tên tài khoản và mật khẩu để đăng nhập</p>
      <?php if (isset($errors)) : ?>
    ...
    ?>
      <form action="<?php echo BASE_URL ?>admin.php?p=user&act=login" method="post">
        ...
        <div class="row">
          <div class="col-xs-8">
            <div class="checkbox icheck">
              <label>
                <input type="checkbox"> Nhớ người dùng
              </label>
            </div>
          </div>
          <!-- /.col -->
      ...
      <a href="<?php echo BASE_URL?>admin.php?p=user&act=register" class="text-center">Chưa có tài khoản? Đăng ký.</a>
