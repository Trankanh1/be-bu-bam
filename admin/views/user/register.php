...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    ?>
    <form action="<?php echo BASE_URL ?>admin.php?p=user&act=register" method="post" >
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit"  name="regsiter"class="btn btn-primary btn-block btn-flat">Register</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
