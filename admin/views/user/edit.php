                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- form start -->
                            <form method="post"action="<?php echo BASE_URL?>admin.php?p=user&act=update&id=<?php echo $user[0]['id'];?> " enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-8"><select name="level" id="">
                                                    <option <?php if($user[0]['level'] == 0) echo "selected"?>
                                                    value="0">Nhân viên</option>
                                                    <option <?php  if($user[0]['level'] == 1) echo "selected" ?>
                        ...
                        <!-- right column -->
                        <div class="col-md-3">
                            <!-- Horizontal Form --><img id="image_upload_preview" class="img-circle" src="<?php echo $user[0]['anh'] ; ?>" style="width: 200px; height: 200px"/>
